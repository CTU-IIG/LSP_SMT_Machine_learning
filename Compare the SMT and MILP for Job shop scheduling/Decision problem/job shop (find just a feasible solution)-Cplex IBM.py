...
# ----------------------------------------------------------------------------
filename = os.path.dirname(os.path.abspath(__file__)) + "/data/jobshop_j300_m15-D.data"
...
mdl.add_constraints((Due_Date[j]-s[j,NB_MACHINES-1]-DURATION[j][NB_MACHINES-1]>=0) for j in range(NB_JOBS) if j<NB_JOBS-1)
