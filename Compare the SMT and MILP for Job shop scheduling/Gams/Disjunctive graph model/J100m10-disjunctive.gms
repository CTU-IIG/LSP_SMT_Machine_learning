...
e1(j,o,jj,oo)$((ord(j)<>ord(jj) or ord(o)<>ord(oo)) and (a(j,o)=a(jj,oo) or a(j,o)=11 or a(jj,oo)=11) and a(j,o)<=11 and a(jj,oo)<=11) .. y(jj,oo,j,o)+y(j,o,jj,oo)=e=1;
...
e5(j,o,jj,oo)$((ord(j)<>ord(jj) or ord(o)<>ord(oo)) and (a(j,o)=a(jj,oo) or a(j,o)=11 or a(jj,oo)=11) and a(j,o)<=11 and a(jj,oo)<=11) .. s(j,o)=g=s(jj,oo)+p(jj,oo)-(1-y(jj,oo,j,o))*G;
e6(j,o)$(ord(j)<>11 and ord(o)=10) .. cmax(j)=g=s(j,o)+p(j,o);
